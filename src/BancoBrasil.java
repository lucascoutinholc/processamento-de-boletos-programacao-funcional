    ...
    public List<Boleto> lerArquivo(String nomeArquivo) {
        ...
        try {
            ...
            while (linhaLida != null) {
                ...
                boleto.setDataVencimento(LocalDate.parse(informacoesDaLinha[2]));
                boleto.setDataPagamento(LocalDateTime.parse(informacoesDaLinha[3]));
                boleto.setValor(Double.parseDouble(informacoesDaLinha[4]));
                boleto.setMulta(Double.parseDouble(informacoesDaLinha[5]));
                boleto.setJuros(Double.parseDouble(informacoesDaLinha[6]));
